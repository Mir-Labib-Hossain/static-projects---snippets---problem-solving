...
public class Priority {
    public static void main(String[] args) {
        ...
        int[] pr = new int[pn];    //Priority
        int[] st = new int[pn];   //Service Time
        System.out.println("Enter Arrival Time, Execute Time (Duration), Priority of each Process");
        for (i = 0; i < pn; i++) {
            p[i] = "P" + i;
        ...
        System.out.println("\nProcess No. |   Arrival Time  |   Execite Time   |   Priority   |    Service Time");
        for (i = 0; i < pn; i++) {
            ...
            System.out.println("     " + p[i] + "     |        " + at[i] + "        |        " + et[i] + "         |        " + pr[i] + "         |        " + st[i]);
        }
